...
const STATUSES_MOCHA = [
  ...
  { key: 'backlog',   label: 'Backlog',     color: '#6c7086', bg: '#25263a', border: 'rgba(108,112,134,0.19)' },
  { key: 'done',      label: 'Done',        color: '#a6e3a1', bg: '#1e2b22', border: 'rgba(166,227,161,0.19)' },
  { key: 'almost_done',label:'Almost Done', color: '#fab387', bg: '#2c2218', border: 'rgba(250,179,135,0.19)' },
];
...
const STATUSES_LATTE = [
  ...
  { key: 'backlog',   label: 'Backlog',     color: '#9ca0b0', bg: '#d8dce8', border: 'rgba(156,160,176,0.25)' },
  { key: 'done',      label: 'Done',        color: '#40a02b', bg: '#d0e8cc', border: 'rgba(64,160,43,0.25)'   },
  { key: 'almost_done',label:'Almost Done', color: '#fe640b', bg: '#fde5d0', border: 'rgba(254,100,11,0.25)'  },
];
